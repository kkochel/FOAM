...
class C4GhServiceTest extends Specification {
    ...
    final ARCHIVED_FILE = "src/test/resources/encrypted_file"
    ...
    final RE_ENCRYPTED_FILE = "src/test/resources/requester/file_21.c4gh"
    ...
    def "Re-encrypt file"() {
        given:
        def sut = new C4ghService(new PosixArchive(bucketName), new PosixOutbox("src/test/resources/"))
        def task = new C4ghExportTask(ARCHIVED_FILE_HEADER, ARCHIVED_FILE, "file_21.c4gh", new File(REQUESTER_PUB_KEY).text, "requester")
