...
class C4GhServiceTest extends Specification {
    ...
    final ARCHIVED_FILE = "encrypted_file"
    ...
    def "Re-encrypt file"() {
        ...
        def task = new C4ghExportTask(ARCHIVED_FILE_HEADER, ARCHIVED_FILE, "encrypted_file.c4gh", new File(REQUESTER_PUB_KEY).text, "requester")
